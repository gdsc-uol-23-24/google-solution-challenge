...
def load_and_process_data(directory, shapes, limit=None, img_size=(28, 28)):
    ...
    for index, shape in enumerate(shapes):
        subdirectory = os.path.join(directory, f'c_{index}')
        if os.path.exists(subdirectory):
            ...
            print(f"Directory for c_{index} not found in {directory}")
...
# Load the data
directory = "UPDATE PATH TO .NPY FILE"  # Update this path
shapes = ['0', '1', '2']
